...
1. Clone the repo
2. Download and untar java (MacOs Apple Silicon) into the spark-client directory spark-client/jdk-22.0.1 - https://download.oracle.com/java/22/latest/jdk-22_linux-x64_bin.tar.gz
